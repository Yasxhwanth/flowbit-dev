      ...
      <div className="flex flex-col gap-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground text-lg">
            Describe your trading strategy in plain English, and we'll build the
            workflow for you.
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Be as specific as possible about indicators, conditions, and order
              details.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end">
              <Button
                ...
                disabled={
                  buildStrategyMutation.isPending || !strategyText.trim()
                }
              >
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between bg-background p-4 rounded-md border">
                <div className="text-sm">
                  ...
                  Nodes,{" "}
                  <span className="font-semibold">
                    {generatedWorkflow.edges.length}
                  </span>{" "}
                  Edges
                </div>

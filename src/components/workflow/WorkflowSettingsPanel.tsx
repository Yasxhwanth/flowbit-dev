          ...
          <div className="space-y-4 pt-4 border-t">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, defaultBroker: value })
                }
                disabled={isSaving}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, defaultSymbol: e.target.value })
                }
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, defaultInterval: value })
                }
                disabled={isSaving}
              >
                <SelectTrigger>
              ...
              <div className="flex flex-wrap gap-1">
                {CRON_PRESETS.map((preset) => (
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setFormData({ ...formData, cron: preset.value })
                    }
                    disabled={isSaving}

...
describe("validateCandleRequest", () => {
  describe("interval validation", () => {
    it("should accept valid intervals for Dhan", () => {
      expect(() =>
        validateCandleRequest({ ...baseRequest, interval: "1m" }, "dhan"),
      ).not.toThrow();
      expect(() =>
        validateCandleRequest({ ...baseRequest, interval: "1d" }, "dhan"),
      ).not.toThrow();
    });

    it("should accept valid intervals for Fyers", () => {
      expect(() =>
        validateCandleRequest({ ...baseRequest, interval: "1m" }, "fyers"),
      ).not.toThrow();
      expect(() =>
        validateCandleRequest({ ...baseRequest, interval: "1d" }, "fyers"),
      ).not.toThrow();
    });

    it("should accept valid intervals for Angel", () => {
      expect(() =>
        validateCandleRequest({ ...baseRequest, interval: "1m" }, "angel"),
      ).not.toThrow();
      expect(() =>
        validateCandleRequest({ ...baseRequest, interval: "1d" }, "angel"),
      ).not.toThrow();
    });
    ...
    it("should reject invalid intervals", () => {
      expect(() =>
        validateCandleRequest(
          { ...baseRequest, interval: "2m" as "1m" },
          "dhan",
        ),
      ).toThrow(BrokerValidationError);
      expect(() =>
        validateCandleRequest(
          { ...baseRequest, interval: "invalid" as "1m" },
          "fyers",
        ),
      ).toThrow(BrokerValidationError);
    });
  ...
  describe("securityId requirement", () => {
    it("should require securityId for Dhan", () => {
      ...
      expect(() =>
        validateCandleRequest(request as CandleRequest, "dhan"),
      ).toThrow(BrokerValidationError);
    });
    ...
    it("should not require securityId for Fyers", () => {
      const request = { ...baseRequest, securityId: undefined };
      expect(() =>
        validateCandleRequest(request as CandleRequest, "fyers"),
      ).not.toThrow();
    });
    ...
    it("should not require securityId for Angel", () => {
      const request = { ...baseRequest, securityId: undefined };
      expect(() =>
        validateCandleRequest(request as CandleRequest, "angel"),
      ).not.toThrow();
    });
  });
  ...
  describe("symbol validation", () => {
    it("should require symbol", () => {
      ...
      expect(() => validateCandleRequest(request, "dhan")).toThrow(
